...
// runs updateVisibility on resize
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  for (var i = 0; i < 72; i++) {
    ...
    // If the position is outside the visible window, assign hidden class
    if ((Math.floor(i / cols) * s) > window.innerHeight || ((i % cols) * s) > (window.innerWidth + 75)) {
      elem.className = 'mover-hidden';
    }
